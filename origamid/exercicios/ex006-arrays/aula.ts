...
function verNumeros(arr: number[]) {
...
function filtroDeNumeros(arr: (string | number)[]) {
...
async function fetchCursos(http: string) {
...
function monstraNaTela(json: Data[]) {
  json.map((object) => {
